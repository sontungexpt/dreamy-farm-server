  ...
  function SiteController() {
    ...
    _defineProperty(this, "search", /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var _req$query, page, limit, keySearch, productsResult, recipesResult, total, data, response;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              ...
              data = [].concat(_toConsumableArray(productsResult.data), _toConsumableArray(recipesResult.data));
              response = {
                status: 'success',

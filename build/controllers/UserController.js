...
var UserController = /*#__PURE__*/_createClass(function UserController() {
  ...
  _defineProperty(this, "register", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
      var _req$body, name, email, password, encryptedPassword, user, salt, token, url;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 10:
            _context2.next = 12;
            return _bcrypt["default"].genSalt(Number(_configs["default"].SALT));
          case 12:
            salt = _context2.sent;
            _context2.next = 15;
          ...
          case 18:
            ...
            url = "".concat(_configs["default"].BASE_URL, "users/").concat(user.id, "/verify/").concat(token.token);
            _context2.next = 22;
            return sendEmail(user.email, "Verify Email", url);
          case 22:
            res.status(201).send({
